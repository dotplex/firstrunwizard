...
<div class="page" data-title="<?php p($l->t('A safe home for all your data')); ?>" data-subtitle="">
	<div class="content content-values">
		<div class="description-block text-center">
			<h2><?php p($l->t('Willkommen in Ihrem dotplex Cloud Account.')); ?></h2>
			<p>
				<?php p($l->t('Hier sind Ihre Mailbox, Termine, Kontakte und Dateispeicher vereint.')); ?>
			</p>
		</div>
		...
		<ul id="wizard-values">
			<li>
				...
				<p class="text-center"><?php p($l->t('Gehostet auf unseren sicheren Servern')); ?><br /><?php p($l->t('im Rechenzentrum in Berlin')); ?></p>
			</li>
			<li>
				...
				<p class="text-center"><?php p($l->t('Offene Standards zum einfachen')); ?><br/><?php p($l->t('und sicheren Teilen Ihrer Daten')); ?></p>
			</li>
			<li>
				...
				<p class="text-center"><?php p($l->t('Auf Basis von Nextcloud - einer 100%% freien')); ?><br /><?php p($l->t('und quelloffenen Software mit aktiver Community')); ?></p>
			</li>
		</ul>
	</div>
</div>
